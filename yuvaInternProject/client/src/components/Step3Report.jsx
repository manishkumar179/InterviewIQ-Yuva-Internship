...
const Step3Report = ({ report }) => {
  ...
  // Download pdf function (used jspdf for pdf creation)
  const downloadPDF = () => {
    ...
    if (finalScore >= 8) {
      ...
      advice =
        "Significant improvement required. Focus on structured thinking, clarity, and confident delivering. Practice answering aloud regularly.";
    }
    ...
    const spliteAdvice = doc.splitTextToSize(advice, contentWidth - 20);
    doc.text(spliteAdvice, margin + 10, currentY + 20);
